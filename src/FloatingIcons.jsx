...
const FloatingControls = () => {
  ...
  return (
    // Gap ko gap-3 se gap-2 kar diya hai taaki compact lage
    <div className="fixed bottom-6 right-6 z-[9999] flex flex-col gap-2">
      
      {/* Inquiry Now */}
      {/* Size ko chota kiya: Mobile (w-8 h-8), Desktop (md:w-10 md:h-10) */}
      <Link to="/contact" className="w-8 h-8 md:w-10 md:h-10 rounded-full shadow-2xl hover:scale-110 transition-transform group flex items-center justify-center relative">
