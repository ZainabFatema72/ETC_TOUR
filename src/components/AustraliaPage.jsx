...
const AustraliaPackage = () => {
  ...
  useEffect(() => {
    ...
    }, 5000); // Har 5 second mein badlega
    ...
    <div className="pt-40 pb-16 bg-gray-50 font-sans">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center mb-20">
          ...
          >
            ...
            <p className="text-lg md:text-xl font-bold text-slate-700 mb-8 italic border-l-4 border-blue-600 pl-4 bg-blue-50/50 py-2">
              SYDNEY (3N) — GOLD COAST (3N) — <br></br>CAIRNS (2N) — MELBOURNE (3N)
            </p>
          ...
          >
            ...
            <div className="absolute -bottom-6 -left-6 bg-blue-600 text-white p-8 hidden md:block shadow-2xl rounded-none">
              ...
              <p className="text-sm font-bold tracking-[0.2em] mt-1">DREAM DESTINATION</p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 items-stretch">
         ...
         {/* TESTIMONIAL CARD - Jeevan Style Inspired */}
<div className="bg-white border border-gray-100 shadow-2xl relative overflow-hidden rounded-none h-[350px] flex flex-col group">
  ...
  <div className="p-8 pt-4 flex flex-col h-full justify-between relative z-10">
    <div className="relative h-56">
      <AnimatePresence mode="wait">
        <motion.div
          key={index}
          // Advanced Animation: Slide + Rotate + Scale
      ...
      {testimonials.map((_, i) => (
        <button
          ...
          className={`group relative h-2 transition-all duration-500 rounded-full overflow-hidden ${
            index === i ? 'w-12 bg-blue-600' : 'w-3 bg-slate-200 hover:bg-slate-300'
          }`}
        >
          {index === i && (
            <motion.div 
  ...
  {/* Aesthetic Background Quote Icon (Bottom Right) */}
